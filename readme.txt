=== SCD - Smart Currency Detector - Premium Variant for Dokan  ===
...
ALL-IN-ONE solution for buyers, sellers, single/multi vendors sites, market places. Best currency plugin for DOKAN Marketplace for currency conversion

= This plugin is compatible to: =

[DOKAN (Dokan - Marketplace )](https://fr.wordpress.org/plugins/dokan-lite/)
...
= How to use SCD (Smart Currency Detector)with Dokan =.
[youtube  https://www.youtube.com/watch?v=MVocPkq-zPM ]
...
* Remove some obsolete settings options on SCD currency settings in dokan vendor dashboard 
* Change plugin name 
* Correct SCD currency settings integration in dokan vendor dashbord menu for mobile view
= 4.7.7 =
* correct issue when add new simple product and variable product
= 4.7.6 =
* hithlight scd currency menu on dokan dashboard after clicking on.
...
= 4.5.9 =
* Fix can't disbale variation on dokan dashbord when scd is activated
